...
function init(id, title, type, form) {
    ...
    core += "<div><font>同时生成前端代码：</font><label><input style=\"width:50px\" name=\"generateView\" type=\"radio\" value=\"1\" checked/>是 </label> <label><input style=\"width:50px\" name=\"generateView\" type=\"radio\" value=\"0\" />否 </label> </div>";
    var after = "";
    if (type === 0) {
